...
const Button = (props) => {
  ...
  return (
    <div className=''>
      <button className='w-full rounded-sm px-12 py-4 text-base text-white font-medium flex items-center' style={{ backgroundColor: color, color: textColor, fontSize: fontSize, fontWeight: fontWeight, transition: "opacity 0.35s" }}
